    ...
    return (
        <>
            <Drawer variant="permanent" open={sidebar}>
                <Divider />
                <List>
                    <ListItem className='listiconsidebar' button key="Notes">
                    ...
                    <ListItem className='listiconsidebar' button key="Archive">
                    ...
                    <ListItem className='listiconsidebar' button key="Trash">
