...
function MenuComponent({ sidebar }) {
    ...
    return (
        <>
            <Drawer variant="permanent" open={sidebar}>
                <Divider />
                <List>
                    <ListItem className='listiconsidebar' button key="Notes" onClick={() => history.push('/dashboard')}>
                        ...
                        {sidebar ? <ListItemText className='sideicon' primary="Notes" /> : null}
                    </ListItem>
                    <ListItem className='listiconsidebar' button key="Reminder">
                        ...
                        {sidebar ? <ListItemText className='sideicon' primary="Reminder" /> : null}
                    </ListItem>

                    <ListItem className='listiconsidebar' button key="Edit Labels">
                        ...
                        {sidebar ? <ListItemText className='sideicon' primary="Edit Labels" /> : null}
                    </ListItem>
                    <ListItem className='listiconsidebar' button key="Archive" onClick={() => history.push('/archive')}>
                        ...
                        {sidebar ? <ListItemText className='sideicon' primary="Archive" /> : null}
                    </ListItem>
                    <ListItem className='listiconsidebar' button key="Trash" onClick={() => history.push('/trash')}>
                        ...
                        {sidebar ? <ListItemText className='sideicon' primary="Trash" /> : null}
                    </ListItem>
                </List>
            </Drawer>
            <DrawerHeader />
